/*
  ...
  - You are about to drop the `deliviries` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "deliviries" DROP CONSTRAINT "deliviries_id_client_fkey";

-- DropForeignKey
ALTER TABLE "deliviries" DROP CONSTRAINT "deliviries_id_deliveryman_fkey";
